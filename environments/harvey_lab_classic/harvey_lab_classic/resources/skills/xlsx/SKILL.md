...
> **Reading is not in scope.** To read an existing .xlsx, use the environment `read` tool. Source documents are text-backed; generated workbooks are parsed by the sandbox parser. This skill is for *writing*, *editing*, and *recalculating*.
